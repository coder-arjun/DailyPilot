        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableMorningReminder = table.Column<bool>(type: "bit", nullable: false),
                    EnableEndOfDayReminder = table.Column<bool>(type: "bit", nullable: false),
                    EnableEmailNotifications = table.Column<bool>(type: "bit", nullable: false),
                    MorningReminderTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    EndOfDayReminderTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    EnableAutoCarryForward = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasksPlanned = table.Column<int>(type: "int", nullable: false),
                    TasksCompleted = table.Column<int>(type: "int", nullable: false),
                    TasksCarriedForward = table.Column<int>(type: "int", nullable: false),
                    CompletionRate = table.Column<double>(type: "float", nullable: false),
                    StreakOnDate = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarryForwardCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsSnapshots_UserId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reminders_IsSent_ScheduledAtUtc",
                table: "Reminders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_UserId_OnDate",
                table: "TaskHistories",
                columns: new[] { "UserId", "OnDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_UserId_PlannedDate",
                table: "Tasks",
